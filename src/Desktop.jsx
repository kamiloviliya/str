...
function БлокПриложений (){
  return(
    <div className='подложкаБлокаПриложений'>
      <div className='приложение п1'/><div className='приложение п2'/><div className='приложение п3'/>
      <div className='приложение п4'/><div className='приложение п5'/><div className='приложение п6'/>
    </div>
  )
}
